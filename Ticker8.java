 ...
 * @author DELL
 */
public class Ticker8 extends TickerBehaviour{


    public Ticker8(Agent a, long period) {
        super(a, period);
    }
    ...
    protected void onTick() {
        System.out.println("We are in Behaviour of team 8");
        ...
        else if(t>=5)
        {
            ...
            {
                System.err.println("Team 8 Wins");
                try{

                        AgentController Team2 = main1.getAgent(opp);
                        Team2.kill();
                        AgentController Team1 = main1.getAgent("Team8");
                        Team1.suspend();
                        mainScore sc = new mainScore("Team8", opp, score, enemeyScore);
                        sc.updateScore("Team8", opp, score, enemeyScore);
        ...
        System.out.println("Content recieved for team 8");
        ...
        ArrayList<Integer> subNum = new ArrayList<Integer>();
            ...
            if(check)
            {
                ...
                else
                {
                    ...
                    masg.addReceiver(new AID(opp,AID.ISLOCALNAME));
                    score++;
                    System.out.println("Team8 Scored Goal!");
                    System.out.println("Score:\n"+opp+" "+enemeyScore+" - "+score+" Team8");
                    if(ScoreBoard!=null){
                    ...
                    masg.setContent("Team8 E "+temp+" "+score);
                    this.getAgent().send(masg);
            ...
            else
            {
                ...
                ScoreBoard = new socreboard("Team8",opp,0,0);
            ...
            System.out.println("Message has not been received yet in team8");

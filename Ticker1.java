 ...
 * @author DELL
 */
public class Ticker1 extends TickerBehaviour{

    public Ticker1(Agent a, long period) {
        super(a, period);
    }
    boolean flag=false;
    int score = 0;
    ...
    protected void onTick() {
        System.out.println("We are in Behaviour of team 1");
        ...
        else if(t>=5)
        {
            ...
            {
                System.err.println("Team 1 Wins");
                try{

                        AgentController Team2 = main1.getAgent(opp);
                        Team2.kill();
                        AgentController Team1 = main1.getAgent("Team1");
                        Team1.suspend();
                        mainScore sc = new mainScore("Team1", opp, score, enemeyScore);
                        sc.updateScore("Team1", opp, score, enemeyScore);
        ...
        System.out.println("Content recieved for team1 ");
        ...
        for(int i = 0 ; i<arr.length;i++)
        {
            ...
            if(check)
            {
                ...
                else
                {
                    ...
                    masg.addReceiver(new AID(opp,AID.ISLOCALNAME));
                    score++;
                    System.out.println("Team1 Scored Goal!");
                    System.out.println("Score:\nTeam1 "+score+" - "+enemeyScore+" "+opp);
                    if(ScoreBoard!=null){
                    ...
                    masg.setContent("Team1 H "+temp+" "+score);
                    this.getAgent().send(masg);
                }
            ...
            else
            {
                ...
                ScoreBoard = new socreboard("Team1",opp,0,0);
            ...
            System.out.println("Message has not been received yet in team 1");

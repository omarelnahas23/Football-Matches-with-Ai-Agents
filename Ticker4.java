 ...
 * @author DELL
 */
public class Ticker4 extends TickerBehaviour{


    public Ticker4(Agent a, long period) {
        super(a, period);
    }
    ...
    protected void onTick() {
        System.out.println("We are in Behaviour of team 4");
        ...
        else if(t>=5)
        {
            ...
            {
                System.err.println("Team 4 Wins");
                try{

                        AgentController Team2 = main1.getAgent(opp);
                        Team2.kill();
                        AgentController Team1 = main1.getAgent("Team4");
                        Team1.suspend();
                        mainScore sc = new mainScore("Team4", opp, score, enemeyScore);
                        sc.updateScore("Team4", opp, score, enemeyScore);
        ...
        System.out.println("Content recieved for team 4");
        ...
        ArrayList<Integer> subNum = new ArrayList<Integer>();
            ...
            if(check)
            {
                ...
                else
                {
                    ...
                    masg.addReceiver(new AID(opp,AID.ISLOCALNAME));
                    score++;
                    System.out.println("Team4 Scored Goal!");
                    System.out.println("Score:\n"+opp+" "+enemeyScore+" - "+score+" Team4");
                    if(ScoreBoard!=null){
                    ...
                    masg.setContent("Team4 E "+temp+" "+score);
                    this.getAgent().send(masg);
            ...
            else
            {
                ...
                ScoreBoard = new socreboard("Team4",opp,0,0);
            ...
            System.out.println("Message has not been received yet in team4");

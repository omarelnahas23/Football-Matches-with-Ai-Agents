 ...
 * @author DELL
 */
public class Ticker9 extends TickerBehaviour{

    public Ticker9(Agent a, long period) {
        super(a, period);
    }
    boolean flag=false;
    int score = 0;
    ...
    protected void onTick() {
        System.out.println("We are in Behaviour of team 9");
        ...
        else if(t>=5)
        {
            ...
            {
                System.err.println("Team 9 Wins");
                try{

                        AgentController Team2 = main1.getAgent(opp);
                        Team2.kill();
                        AgentController Team1 = main1.getAgent("Team9");
                        Team1.suspend();
                        mainScore sc = new mainScore("Team9", opp, score, enemeyScore);
                        sc.updateScore("Team9", opp, score, enemeyScore);
        ...
        System.out.println("Content recieved for team9 ");
        ...
        for(int i = 0 ; i<arr.length;i++)
        {
            ...
            if(check)
            {
                ...
                else
                {
                    ...
                    masg.addReceiver(new AID(opp,AID.ISLOCALNAME));
                    score++;
                    System.out.println("Team9 Scored Goal!");
                    System.out.println("Score:\nTeam9 "+score+" - "+enemeyScore+" "+opp);
                    if(ScoreBoard!=null){
                    ...
                    masg.setContent("Team9 H "+temp+" "+score);
                    this.getAgent().send(masg);
                }
            ...
            else
            {
                ...
                ScoreBoard = new socreboard("Team9",opp,0,0);
            ...
            System.out.println("Message has not been received yet in team 9");

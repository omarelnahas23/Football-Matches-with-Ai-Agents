 ...
 * @author DELL
 */
public class Ticker16 extends TickerBehaviour{


    public Ticker16(Agent a, long period) {
        super(a, period);
    }
    ...
    protected void onTick() {
        System.out.println("We are in Behaviour of team 16");
        ...
        else if(t>=5)
        {
            ...
            {
                System.err.println("Team 16 Wins");
                try{

                        AgentController Team2 = main1.getAgent(opp);
                        Team2.kill();
                        AgentController Team1 = main1.getAgent("Team16");
                        Team1.suspend();
                        mainScore sc = new mainScore("Team16", opp, score, enemeyScore);
                        sc.updateScore("Team16", opp, score, enemeyScore);
        ...
        System.out.println("Content recieved for team 16");
        ...
        ArrayList<Integer> subNum = new ArrayList<Integer>();
            ...
            if(check)
            {
                ...
                else
                {
                    ...
                    masg.addReceiver(new AID(opp,AID.ISLOCALNAME));
                    score++;
                    System.out.println("Team16 Scored Goal!");
                    System.out.println("Score:\n"+opp+" "+enemeyScore+" - "+score+" Team16");
                    if(ScoreBoard!=null){
                    ...
                    masg.setContent("Team16 E "+temp+" "+score);
                    this.getAgent().send(masg);
            ...
            else
            {
                ...
                ScoreBoard = new socreboard("Team16",opp,0,0);
            ...
            System.out.println("Message has not been received yet in team16");

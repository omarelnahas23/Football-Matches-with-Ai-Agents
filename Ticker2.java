 ...
 * @author DELL
 */
public class Ticker2 extends TickerBehaviour{


    public Ticker2(Agent a, long period) {
        super(a, period);
    }
    ...
    protected void onTick() {
        System.out.println("We are in Behaviour of team 2");
        ...
        else if(t>=5)
        {
            ...
            {
                System.err.println("Team 2 Wins");
                try{

                        AgentController Team2 = main1.getAgent(opp);
                        Team2.kill();
                        AgentController Team1 = main1.getAgent("Team2");
                        Team1.suspend();
                        mainScore sc = new mainScore("Team2", opp, score, enemeyScore);
                        sc.updateScore("Team2", opp, score, enemeyScore);
        ...
        System.out.println("Content recieved for team 2");
        ...
        ArrayList<Integer> subNum = new ArrayList<Integer>();
            ...
            if(check)
            {
                ...
                else
                {
                    ...
                    masg.setContent("Team2 E "+temp+" "+score);
                    this.getAgent().send(masg);
            ...
            else
            {
                ...
                ScoreBoard = new socreboard("Team2",opp,0,0);
            ...
            System.out.println("Message has not been received yet in team2");

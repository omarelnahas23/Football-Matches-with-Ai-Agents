 ...
 * @author DELL
 */
public class Ticker11 extends TickerBehaviour{


    public Ticker11(Agent a, long period) {
        super(a, period);
    }
    ...
    protected void onTick() {
        System.out.println("We are in Behaviour of team 11");
        ...
        else if(t>=5)
        {
            ...
            {
                System.err.println("Team 11 Wins");
                try{

                        AgentController Team2 = main1.getAgent(opp);
                        Team2.kill();
                        AgentController Team1 = main1.getAgent("Team11");
                        Team1.suspend();
                        mainScore sc = new mainScore("Team11", opp, score, enemeyScore);
                        sc.updateScore("Team11", opp, score, enemeyScore);
        ...
        System.out.println("Content recieved for team 11");
        ...
        ArrayList<Integer> subNum = new ArrayList<Integer>();
            ...
            if(check)
            {
                ...
                else
                {
                    ...
                    masg.addReceiver(new AID(opp,AID.ISLOCALNAME));
                    score++;
                    System.out.println("Team2 Scored Goal!");
                    System.out.println("Score:\n"+opp+" "+enemeyScore+" - "+score+" Team2");
                    if(ScoreBoard!=null){
                    ...
                    masg.setContent("Team11 E "+temp+" "+score);
                    this.getAgent().send(masg);
            ...
            else
            {
                ...
                ScoreBoard = new socreboard("Team11",opp,0,0);
                ...
                else
                {
                    ...
                    masg.addReceiver(new AID(opp,AID.ISLOCALNAME));
                    score++;
                    System.out.println("Team11 Scored Goal!");
                    System.out.println("Score:\n"+opp+" "+enemeyScore+" - "+score+" Team11");
                    if(ScoreBoard!=null){
                    ScoreBoard.updateScore(score, enemeyScore);
                    }
            ...
            System.out.println("Message has not been received yet in team11");

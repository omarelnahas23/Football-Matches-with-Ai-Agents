 ...
 * @author DELL
 */
public class Ticker12 extends TickerBehaviour{

    public Ticker12(Agent a, long period) {
        super(a, period);
    }
    boolean flag=false;
    int score = 0;
    ...
    protected void onTick() {
        System.out.println("We are in Behaviour of team 12");
        ...
        else if(t>=5)
        {
            ...
            {
                System.err.println("Team 12 Wins");
                try{

                        AgentController Team2 = main1.getAgent(opp);
                        Team2.kill();
                        AgentController Team1 = main1.getAgent("Team12");
                        Team1.suspend();
                        mainScore sc = new mainScore("Team12", opp, score, enemeyScore);
                        sc.updateScore("Team12", opp, score, enemeyScore);
        ...
        System.out.println("Content recieved for team12 ");
        ...
        for(int i = 0 ; i<arr.length;i++)
        {
            ...
            if(check)
            {
                ...
                else
                {
                    ...
                    masg.addReceiver(new AID(opp,AID.ISLOCALNAME));
                    score++;
                    System.out.println("Team12 Scored Goal!");
                    System.out.println("Score:\nTeam12 "+score+" - "+enemeyScore+" "+opp);
                    if(ScoreBoard!=null){
                    ...
                    masg.setContent("Team12 H "+temp+" "+score);
                    this.getAgent().send(masg);
                }
            ...
            else
            {
                ...
                ScoreBoard = new socreboard("Team12",opp,0,0);
            ...
            System.out.println("Message has not been received yet in team 12");

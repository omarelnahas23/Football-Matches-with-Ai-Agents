 ...
 * @author DELL
 */
public class Ticker15 extends TickerBehaviour{


    public Ticker15(Agent a, long period) {
        super(a, period);
    }
    ...
    protected void onTick() {
        System.out.println("We are in Behaviour of team 15");
        ...
        else if(t>=5)
        {
            ...
            {
                System.err.println("Team 15 Wins");
                try{

                        AgentController Team2 = main1.getAgent(opp);
                        Team2.kill();
                        AgentController Team1 = main1.getAgent("Team15");
                        Team1.suspend();
                        mainScore sc = new mainScore("Team15", opp, score, enemeyScore);
                        sc.updateScore("Team15", opp, score, enemeyScore);
        ...
        System.out.println("Content recieved for team 15");
        ...
        ArrayList<Integer> subNum = new ArrayList<Integer>();
            ...
            if(check)
            {
                ...
                else
                {
                    ...
                    masg.addReceiver(new AID(opp,AID.ISLOCALNAME));
                    score++;
                    System.out.println("Team15 Scored Goal!");
                    System.out.println("Score:\n"+opp+" "+enemeyScore+" - "+score+" Team15");
                    if(ScoreBoard!=null){
                    ...
                    masg.setContent("Team15 E "+temp+" "+score);
                    this.getAgent().send(masg);
            ...
            else
            {
                ...
                ScoreBoard = new socreboard("Team15",opp,0,0);
            ...
            System.out.println("Message has not been received yet in team15");

 ...
 * @author DELL
 */
public class Ticker6 extends TickerBehaviour{


    public Ticker6(Agent a, long period) {
        super(a, period);
    }
    ...
    protected void onTick() {
        System.out.println("We are in Behaviour of team 6");
        ...
        else if(t>=5)
        {
            ...
            {
                System.err.println("Team 6 Wins");
                try{

                        AgentController Team2 = main1.getAgent(opp);
                        Team2.kill();
                        AgentController Team1 = main1.getAgent("Team6");
                        Team1.suspend();
                        mainScore sc = new mainScore("Team6", opp, score, enemeyScore);
                        sc.updateScore("Team6", opp, score, enemeyScore);
        ...
        System.out.println("Content recieved for team 6");
        ...
        ArrayList<Integer> subNum = new ArrayList<Integer>();
            ...
            if(check)
            {
                ...
                else
                {
                    ...
                    masg.addReceiver(new AID(opp,AID.ISLOCALNAME));
                    score++;
                    System.out.println("Team6 Scored Goal!");
                    System.out.println("Score:\n"+opp+" "+enemeyScore+" - "+score+" Team6");
                    if(ScoreBoard!=null){
                    ...
                    masg.setContent("Team6 E "+temp+" "+score);
                    this.getAgent().send(masg);
            ...
            else
            {
                ...
                ScoreBoard = new socreboard("Team6",opp,0,0);
            ...
            System.out.println("Message has not been received yet in team6");

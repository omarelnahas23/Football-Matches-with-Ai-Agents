 ...
 * @author DELL
 */
public class Ticker5 extends TickerBehaviour{

    public Ticker5(Agent a, long period) {
        super(a, period);
    }
    boolean flag=false;
    int score = 0;
    ...
    protected void onTick() {
        System.out.println("We are in Behaviour of team 5");
        ...
        else if(t>=5)
        {
            ...
            {
                System.err.println("Team 5 Wins");
                try{

                        AgentController Team2 = main1.getAgent(opp);
                        Team2.kill();
                        AgentController Team1 = main1.getAgent("Team5");
                        Team1.suspend();
                        mainScore sc = new mainScore("Team5", opp, score, enemeyScore);
                        sc.updateScore("Team5", opp, score, enemeyScore);
        ...
        System.out.println("Content recieved for team5 ");
        ...
        for(int i = 0 ; i<arr.length;i++)
        {
            ...
            if(check)
            {
                ...
                else
                {
                    ...
                    masg.addReceiver(new AID(opp,AID.ISLOCALNAME));
                    score++;
                    System.out.println("Team5 Scored Goal!");
                    System.out.println("Score:\nTeam5 "+score+" - "+enemeyScore+" "+opp);
                    if(ScoreBoard!=null){
                    ...
                    masg.setContent("Team5 H "+temp+" "+score);
                    this.getAgent().send(masg);
                }
            ...
            else
            {
                ...
                ScoreBoard = new socreboard("Team5",opp,0,0);
            ...
            System.out.println("Message has not been received yet in team 5");
